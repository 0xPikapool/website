...
Bidders submit their auction bids as [ERC721 meta-transactions](https://medium.com/metamask/eip712-is-coming-what-to-expect-and-how-to-use-it-bb92fd1a7a26) to the Pikapool darkpool, where the are ordered by tip.
