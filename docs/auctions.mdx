...
<div>
<span>Bids are submitted to the Pikapool darkpool as <a href="https://medium.com/metamask/eip712-is-coming-what-to-expect-and-how-to-use-it-bb92fd1a7a26">ERC712 meta-transactions</a>.</span>
...
Now, users craft and submit bids as meta-transactions to the Pikapool darkpool.
