...
Pikapool does for NFT minting what [CowSwap](https://swap.cow.fi/) did for DEX trading.  Using an NFT specific mempool, projects can capture additional revenue from the inefficiencies of bidding in the public mempool. ⚡️Sometimes up to 50% of mint gas fees.⚡️
